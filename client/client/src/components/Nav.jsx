...
export default function Nav() {
  ...
  return (
    <AppBar position="static" sx={{ background:"#42A5F5", fontFamily:"Inter, sans-serif", letterSpacing:"0.1px" }}>
      <Toolbar sx={{ display:"flex", gap:2, alignItems:"center" }}>
        
        {/* Logo */}
        <Link to="/" style={{ textDecoration:"none", fontWeight:700, fontSize:22, color:"white" }}>
          ConfNest
        </Link>
        ...
        <div style={{ marginLeft:"auto", display:"flex", gap:12 }}>
          ...
          {!user && (
            <>
              <Link to="/register" style={pill} onMouseEnter={e=>Object.assign(e.target.style,pillHover)} onMouseLeave={e=>Object.assign(e.target.style,pill)}>
                Register Author
              </Link>
              <Link to="/register-attendee" style={pill} onMouseEnter={e=>Object.assign(e.target.style,pillHover)} onMouseLeave={e=>Object.assign(e.target.style,pill)}>
                Register Attendee
              </Link>
              <Link to="/login" style={pill} onMouseEnter={e=>Object.assign(e.target.style,pillHover)} onMouseLeave={e=>Object.assign(e.target.style,pill)}>
                Login
              </Link>
            </>
          )}
          ...
          {user?.role === "AUTHOR" && (
            <Link to="/conferences" style={pill} onMouseEnter={e=>Object.assign(e.target.style,pillHover)} onMouseLeave={e=>Object.assign(e.target.style,pill)}>
              Conferences
            </Link>
          )}
          ...
          {user?.role === "ATTENDEE" && (
            <>
              <Link to="/conferences" style={pill} onMouseEnter={e=>Object.assign(e.target.style,pillHover)} onMouseLeave={e=>Object.assign(e.target.style,pill)}>Conferences</Link>
              <Link to="/my-conferences" style={pill} onMouseEnter={e=>Object.assign(e.target.style,pillHover)} onMouseLeave={e=>Object.assign(e.target.style,pill)}>My Conferences</Link>
            </>
          )}
