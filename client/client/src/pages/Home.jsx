...
export default function Home() {
  ...
  if (user.role === "CHAIR") {
    cards.push(
      ...
      { label: "Pending Decisions", icon: <AssignmentOutlinedIcon />, link: "/pending-decisions", sub: "View Your Pending Decisions" },
    )
  }
  ...
  if (user.role === "REVIEWER") {
    cards.push(
      { label: "My Assigned Papers", icon: <AssignmentOutlinedIcon />, link: "/assigned", sub: "Your assignments" },
      { label: "Pending Reviews", icon: <RateReviewOutlinedIcon />, link: "/pending-reviews", sub: "Review pending papers" },
    )
  }
